      ...
      <div className="div">
        ...
        <div className="overlap-group">
          ...
          <form className="frame" onSubmit={handleSubmit}>
            ...
            <div className="frame-7">
              <p className="dengan-mendaftar">
                <span className="span">
                  Dengan mendaftar, Anda bertanggung jawab atas akun tersebut
                  sesuai dengan Syarat, Ketentuan &amp; Kebijakan Privasi.
                </span>
              </p>
            </div>
            <button className="frame-11" type="submit">
              Daftar
            </button>
            <div className="frame-7">
              <p className="sudah-memiliki-akun">
                <span className="text-wrapper-8">Sudah memiliki akun? </span>
                <Link to="/SignIn" className="text-wrapper-9">
                  {' '}
                  Masuk Sekarang
                </Link>
              </p>
          ...
          <div className="frame-13">
            ...
            <button className="login-facebook-2">
              Login&nbsp;&nbsp;Facebook
            </button>
          </div>
        </div>
